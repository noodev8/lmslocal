...
class CompetitionModel extends Competition {
  const CompetitionModel({
    ...
    super.currentRoundLockTime,
    super.totalFixtures,
    super.fixturesWithResults,
    super.fixturesProcessed,
  ...
  factory CompetitionModel.fromJson(Map<String, dynamic> json) {
    return CompetitionModel(
      ...
      currentRoundLockTime: json['current_round_lock_time'] != null
          ? DateTime.parse(json['current_round_lock_time'] as String)
          : null,
      totalFixtures: json['total_fixtures'] as int? ?? 0,
      fixturesWithResults: json['fixtures_with_results'] as int? ?? 0,
      fixturesProcessed: json['fixtures_processed'] as int? ?? 0,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'current_round_lock_time': currentRoundLockTime?.toIso8601String(),
