...
-- Started on 2025-11-26 17:34:37
...
--
-- TOC entry 256 (class 1259 OID 22747)
-- Name: app_version; Type: TABLE; Schema: public; Owner: lmslocal_prod_user
--

CREATE TABLE public.app_version (
    id integer NOT NULL,
    platform character varying(10) NOT NULL,
    minimum_version character varying(20) NOT NULL,
    store_url text NOT NULL
);


ALTER TABLE public.app_version OWNER TO lmslocal_prod_user;

--
-- TOC entry 255 (class 1259 OID 22746)
-- Name: app_version_id_seq; Type: SEQUENCE; Schema: public; Owner: lmslocal_prod_user
--
...
ALTER SEQUENCE public.app_version_id_seq OWNER TO lmslocal_prod_user;

--
-- TOC entry 3732 (class 0 OID 0)
-- Dependencies: 255
-- Name: app_version_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lmslocal_prod_user
--
...
CREATE TABLE public.competition (
    ...
    prize_structure character varying(500)
);
...
-- Dependencies: 222
-- Name: COLUMN competition.entry_fee; Type: COMMENT; Schema: public; Owner: lmslocal_prod_user
--

COMMENT ON COLUMN public.competition.entry_fee IS 'Suggested entry fee amount - pub can use different amount with
  players';
...
-- Dependencies: 222
-- Name: COLUMN competition.prize_structure; Type: COMMENT; Schema: public; Owner: lmslocal_prod_user
--

COMMENT ON COLUMN public.competition.prize_structure IS 'Prize distribution description (e.g., "50% Winner / 50%
  Charity")';
...
CREATE TABLE public.competition_user (
    ...
    manage_results boolean DEFAULT false NOT NULL,
    manage_fixtures boolean DEFAULT false NOT NULL,
    manage_players boolean DEFAULT false NOT NULL,
    manage_promote boolean DEFAULT false,
    player_display_name character varying(100)
);
...
-- Dependencies: 224
-- Name: COLUMN competition_user.manage_results; Type: COMMENT; Schema: public; Owner: lmslocal_prod_user
--

COMMENT ON COLUMN public.competition_user.manage_results IS 'Allow user to enter and process match results (organiser delegate permission)';


--
-- TOC entry 3746 (class 0 OID 0)
-- Dependencies: 224
-- Name: COLUMN competition_user.manage_fixtures; Type: COMMENT; Schema: public; Owner: lmslocal_prod_user
--

COMMENT ON COLUMN public.competition_user.manage_fixtures IS 'Allow user to add and modify fixtures (organiser delegate permission)';


--
-- TOC entry 3747 (class 0 OID 0)
-- Dependencies: 224
-- Name: COLUMN competition_user.manage_players; Type: COMMENT; Schema: public; Owner: lmslocal_prod_user
--

COMMENT ON COLUMN public.competition_user.manage_players IS 'Allow user to add, remove, and manage players (organiser delegate permission)';


--
-- TOC entry 3748 (class 0 OID 0)
-- Dependencies: 224
-- Name: COLUMN competition_user.manage_promote; Type: COMMENT; Schema: public; Owner: lmslocal_prod_user
--

COMMENT ON COLUMN public.competition_user.manage_promote IS 'Whether this user has been delegated permission to access promotion/marketing features for the
  competition by the main organiser';
...
--
-- TOC entry 260 (class 1259 OID 22813)
-- Name: device_tokens; Type: TABLE; Schema: public; Owner: lmslocal_prod_user
--
...
ALTER TABLE public.device_tokens OWNER TO lmslocal_prod_user;

--
-- TOC entry 259 (class 1259 OID 22812)
-- Name: device_tokens_id_seq; Type: SEQUENCE; Schema: public; Owner: lmslocal_prod_user
--
...
ALTER SEQUENCE public.device_tokens_id_seq OWNER TO lmslocal_prod_user;

--
-- TOC entry 3753 (class 0 OID 0)
-- Dependencies: 259
-- Name: device_tokens_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lmslocal_prod_user
--
...
--
-- TOC entry 258 (class 1259 OID 22803)
-- Name: mobile_notification_queue; Type: TABLE; Schema: public; Owner: lmslocal_prod_user
--
...
ALTER TABLE public.mobile_notification_queue OWNER TO lmslocal_prod_user;

--
-- TOC entry 257 (class 1259 OID 22802)
-- Name: mobile_notification_queue_id_seq; Type: SEQUENCE; Schema: public; Owner: lmslocal_prod_user
--

CREATE SEQUENCE public.mobile_notification_queue_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.mobile_notification_queue_id_seq OWNER TO lmslocal_prod_user;

--
-- TOC entry 3781 (class 0 OID 0)
-- Dependencies: 257
-- Name: mobile_notification_queue_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lmslocal_prod_user
--

ALTER SEQUENCE public.mobile_notification_queue_id_seq OWNED BY public.mobile_notification_queue.id;


--
-- TOC entry 254 (class 1259 OID 22635)
-- Name: onboarding_applications; Type: TABLE; Schema: public; Owner: lmslocal_prod_user
--
...
ALTER TABLE public.onboarding_applications OWNER TO lmslocal_prod_user;

--
-- TOC entry 3782 (class 0 OID 0)
-- Dependencies: 254
-- Name: TABLE onboarding_applications; Type: COMMENT; Schema: public; Owner: lmslocal_prod_user
--

COMMENT ON TABLE public.onboarding_applications IS 'Stores onboarding applications from venues/organizers for free setup support';


--
-- TOC entry 3783 (class 0 OID 0)
-- Dependencies: 254
-- Name: COLUMN onboarding_applications.venue_type; Type: COMMENT; Schema: public; Owner: lmslocal_prod_user
--

COMMENT ON COLUMN public.onboarding_applications.venue_type IS 'Type of venue: pub, club, workplace, friends, other';


--
-- TOC entry 3784 (class 0 OID 0)
-- Dependencies: 254
-- Name: COLUMN onboarding_applications.status; Type: COMMENT; Schema: public; Owner: lmslocal_prod_user
--

COMMENT ON COLUMN public.onboarding_applications.status IS 'Application status: pending, contacted, approved, rejected, completed';


--
-- TOC entry 3785 (class 0 OID 0)
-- Dependencies: 254
-- Name: COLUMN onboarding_applications.notes; Type: COMMENT; Schema: public; Owner: lmslocal_prod_user
--

COMMENT ON COLUMN public.onboarding_applications.notes IS 'Internal notes for tracking application progress';


--
-- TOC entry 253 (class 1259 OID 22634)
-- Name: onboarding_applications_id_seq; Type: SEQUENCE; Schema: public; Owner: lmslocal_prod_user
--

CREATE SEQUENCE public.onboarding_applications_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.onboarding_applications_id_seq OWNER TO lmslocal_prod_user;

--
-- TOC entry 3786 (class 0 OID 0)
-- Dependencies: 253
-- Name: onboarding_applications_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lmslocal_prod_user
--

ALTER SEQUENCE public.onboarding_applications_id_seq OWNED BY public.onboarding_applications.id;
...
--
-- TOC entry 3401 (class 2604 OID 21001)
...
--
-- TOC entry 3361 (class 2604 OID 20646)
...
--
-- TOC entry 3430 (class 2604 OID 22750)
-- Name: app_version id; Type: DEFAULT; Schema: public; Owner: lmslocal_prod_user
--
...
--
-- TOC entry 3397 (class 2604 OID 20814)
...
--
-- TOC entry 3375 (class 2604 OID 20720)
...
--
-- TOC entry 3381 (class 2604 OID 20740)
...
--
-- TOC entry 3424 (class 2604 OID 22301)
...
--
-- TOC entry 3426 (class 2604 OID 22345)
...
--
-- TOC entry 3434 (class 2604 OID 22816)
-- Name: device_tokens id; Type: DEFAULT; Schema: public; Owner: lmslocal_prod_user
--
...
--
-- TOC entry 3412 (class 2604 OID 21675)
...
--
-- TOC entry 3406 (class 2604 OID 21635)
...
--
-- TOC entry 3410 (class 2604 OID 21654)
...
--
-- TOC entry 3392 (class 2604 OID 20772)
...
--
-- TOC entry 3403 (class 2604 OID 21535)
...
--
-- TOC entry 3431 (class 2604 OID 22806)
-- Name: mobile_notification_queue id; Type: DEFAULT; Schema: public; Owner: lmslocal_prod_user
--

ALTER TABLE ONLY public.mobile_notification_queue ALTER COLUMN id SET DEFAULT nextval('public.mobile_notification_queue_id_seq'::regclass);


--
-- TOC entry 3428 (class 2604 OID 22638)
-- Name: onboarding_applications id; Type: DEFAULT; Schema: public; Owner: lmslocal_prod_user
--

ALTER TABLE ONLY public.onboarding_applications ALTER COLUMN id SET DEFAULT nextval('public.onboarding_applications_id_seq'::regclass);


--
-- TOC entry 3395 (class 2604 OID 20784)
...
--
-- TOC entry 3399 (class 2604 OID 20985)
...
--
-- TOC entry 3422 (class 2604 OID 21739)
...
--
-- TOC entry 3416 (class 2604 OID 21717)
...
--
-- TOC entry 3390 (class 2604 OID 20758)
...
--
-- TOC entry 3371 (class 2604 OID 20706)
...
--
-- TOC entry 3367 (class 2604 OID 20693)
...
--
-- TOC entry 3499 (class 2606 OID 21004)
...
--
-- TOC entry 3441 (class 2606 OID 20655)
...
--
-- TOC entry 3569 (class 2606 OID 22754)
-- Name: app_version app_version_pkey; Type: CONSTRAINT; Schema: public; Owner: lmslocal_prod_user
--
...
--
-- TOC entry 3489 (class 2606 OID 20819)
...
--
-- TOC entry 3456 (class 2606 OID 20731)
...
--
-- TOC entry 3462 (class 2606 OID 20748)
...
--
-- TOC entry 3553 (class 2606 OID 22304)
...
--
-- TOC entry 3558 (class 2606 OID 22350)
...
--
-- TOC entry 3574 (class 2606 OID 22822)
-- Name: device_tokens device_tokens_pkey; Type: CONSTRAINT; Schema: public; Owner: lmslocal_prod_user
--
...
--
-- TOC entry 3576 (class 2606 OID 22824)
-- Name: device_tokens device_tokens_user_id_fcm_token_key; Type: CONSTRAINT; Schema: public; Owner: lmslocal_prod_user
--
...
--
-- TOC entry 3532 (class 2606 OID 21680)
...
--
-- TOC entry 3511 (class 2606 OID 21642)
...
--
-- TOC entry 3522 (class 2606 OID 21661)
...
--
-- TOC entry 3524 (class 2606 OID 21659)
...
--
-- TOC entry 3508 (class 2606 OID 21540)
...
--
-- TOC entry 3478 (class 2606 OID 20776)
...
--
-- TOC entry 3572 (class 2606 OID 22810)
-- Name: mobile_notification_queue mobile_notification_queue_pkey; Type: CONSTRAINT; Schema: public; Owner: lmslocal_prod_user
--
...
--
-- TOC entry 3567 (class 2606 OID 22643)
-- Name: onboarding_applications onboarding_applications_pkey; Type: CONSTRAINT; Schema: public; Owner: lmslocal_prod_user
--
...
--
-- TOC entry 3487 (class 2606 OID 20788)
...
--
-- TOC entry 3497 (class 2606 OID 20988)
...
--
-- TOC entry 3549 (class 2606 OID 21744)
...
--
-- TOC entry 3542 (class 2606 OID 21731)
...
--
-- TOC entry 3544 (class 2606 OID 21729)
...
--
-- TOC entry 3476 (class 2606 OID 20763)
...
--
-- TOC entry 3450 (class 2606 OID 20698)
...
--
-- TOC entry 3454 (class 2606 OID 20713)
...
--
-- TOC entry 3506 (class 2606 OID 21006)
...
--
-- TOC entry 3537 (class 2606 OID 21684)
...
--
-- TOC entry 3551 (class 2606 OID 21746)
...
--
-- TOC entry 3500 (class 1259 OID 21044)
...
--
-- TOC entry 3501 (class 1259 OID 21009)
...
--
-- TOC entry 3502 (class 1259 OID 21007)
...
--
-- TOC entry 3503 (class 1259 OID 21010)
...
--
-- TOC entry 3504 (class 1259 OID 21008)
...
--
-- TOC entry 3442 (class 1259 OID 20658)
...
--
-- TOC entry 3443 (class 1259 OID 20657)
...
--
-- TOC entry 3444 (class 1259 OID 20656)
...
--
-- TOC entry 3445 (class 1259 OID 20659)
...
--
-- TOC entry 3490 (class 1259 OID 20820)
...
--
-- TOC entry 3491 (class 1259 OID 20822)
...
--
-- TOC entry 3492 (class 1259 OID 20821)
...
--
-- TOC entry 3463 (class 1259 OID 20749)
...
--
-- TOC entry 3464 (class 1259 OID 20751)
...
--
-- TOC entry 3465 (class 1259 OID 20753)
...
--
-- TOC entry 3466 (class 1259 OID 20750)
...
--
-- TOC entry 3457 (class 1259 OID 20735)
...
--
-- TOC entry 3458 (class 1259 OID 21048)
...
--
-- TOC entry 3459 (class 1259 OID 20734)
...
--
-- TOC entry 3460 (class 1259 OID 20733)
...
--
-- TOC entry 3467 (class 1259 OID 21050)
...
--
-- TOC entry 3468 (class 1259 OID 21043)
...
--
-- TOC entry 3469 (class 1259 OID 21049)
...
--
-- TOC entry 3470 (class 1259 OID 21042)
...
--
-- TOC entry 3554 (class 1259 OID 22317)
...
--
-- TOC entry 3555 (class 1259 OID 22316)
...
--
-- TOC entry 3556 (class 1259 OID 22315)
...
--
-- TOC entry 3559 (class 1259 OID 22369)
...
--
-- TOC entry 3560 (class 1259 OID 22368)
...
--
-- TOC entry 3561 (class 1259 OID 22367)
...
--
-- TOC entry 3562 (class 1259 OID 22366)
...
--
-- TOC entry 3533 (class 1259 OID 21682)
...
--
-- TOC entry 3534 (class 1259 OID 21685)
...
--
-- TOC entry 3535 (class 1259 OID 21681)
...
--
-- TOC entry 3512 (class 1259 OID 21648)
...
--
-- TOC entry 3513 (class 1259 OID 21646)
...
--
-- TOC entry 3514 (class 1259 OID 21649)
...
--
-- TOC entry 3515 (class 1259 OID 21699)
...
--
-- TOC entry 3516 (class 1259 OID 21644)
...
--
-- TOC entry 3517 (class 1259 OID 21643)
...
--
-- TOC entry 3518 (class 1259 OID 21647)
...
--
-- TOC entry 3519 (class 1259 OID 21700)
...
--
-- TOC entry 3520 (class 1259 OID 21645)
...
--
-- TOC entry 3525 (class 1259 OID 21663)
...
--
-- TOC entry 3526 (class 1259 OID 21666)
...
--
-- TOC entry 3527 (class 1259 OID 21667)
...
--
-- TOC entry 3528 (class 1259 OID 21665)
...
--
-- TOC entry 3529 (class 1259 OID 21664)
...
--
-- TOC entry 3530 (class 1259 OID 21662)
...
--
-- TOC entry 3479 (class 1259 OID 20779)
...
--
-- TOC entry 3509 (class 1259 OID 21542)
...
--
-- TOC entry 3480 (class 1259 OID 20777)
...
--
-- TOC entry 3481 (class 1259 OID 21706)
...
--
-- TOC entry 3570 (class 1259 OID 22811)
-- Name: idx_mobile_notification_queue_pending; Type: INDEX; Schema: public; Owner: lmslocal_prod_user
--

CREATE INDEX idx_mobile_notification_queue_pending ON public.mobile_notification_queue USING btree (status, created_at) WHERE ((status)::text = 'pending'::text);


--
-- TOC entry 3563 (class 1259 OID 22646)
-- Name: idx_onboarding_applications_created_at; Type: INDEX; Schema: public; Owner: lmslocal_prod_user
--

CREATE INDEX idx_onboarding_applications_created_at ON public.onboarding_applications USING btree (created_at DESC);


--
-- TOC entry 3564 (class 1259 OID 22645)
-- Name: idx_onboarding_applications_email; Type: INDEX; Schema: public; Owner: lmslocal_prod_user
--

CREATE INDEX idx_onboarding_applications_email ON public.onboarding_applications USING btree (email);


--
-- TOC entry 3565 (class 1259 OID 22644)
-- Name: idx_onboarding_applications_status; Type: INDEX; Schema: public; Owner: lmslocal_prod_user
--
...
--
-- TOC entry 3482 (class 1259 OID 20792)
...
--
-- TOC entry 3483 (class 1259 OID 20789)
...
--
-- TOC entry 3484 (class 1259 OID 20793)
...
--
-- TOC entry 3485 (class 1259 OID 20790)
...
--
-- TOC entry 3493 (class 1259 OID 20990)
...
--
-- TOC entry 3494 (class 1259 OID 20989)
...
--
-- TOC entry 3495 (class 1259 OID 20991)
...
--
-- TOC entry 3538 (class 1259 OID 21733)
...
--
-- TOC entry 3539 (class 1259 OID 21732)
...
--
-- TOC entry 3540 (class 1259 OID 21734)
...
--
-- TOC entry 3545 (class 1259 OID 21747)
...
--
-- TOC entry 3546 (class 1259 OID 21749)
...
--
-- TOC entry 3547 (class 1259 OID 21748)
...
--
-- TOC entry 3471 (class 1259 OID 21051)
...
--
-- TOC entry 3472 (class 1259 OID 20764)
...
--
-- TOC entry 3473 (class 1259 OID 20767)
...
--
-- TOC entry 3474 (class 1259 OID 20765)
...
--
-- TOC entry 3451 (class 1259 OID 20714)
...
--
-- TOC entry 3446 (class 1259 OID 20700)
...
--
-- TOC entry 3447 (class 1259 OID 20701)
...
--
-- TOC entry 3448 (class 1259 OID 20699)
...
--
-- TOC entry 3452 (class 1259 OID 20715)
...
--
-- TOC entry 3577 (class 2606 OID 22310)
...
--
-- TOC entry 3578 (class 2606 OID 22305)
...
--
-- TOC entry 3579 (class 2606 OID 22356)
...
--
-- TOC entry 3580 (class 2606 OID 22361)
...
--
-- TOC entry 3581 (class 2606 OID 22351)
...
--
-- TOC entry 2149 (class 826 OID 20641)
...
--
-- TOC entry 2148 (class 826 OID 20640)
...
-- Completed on 2025-11-26 17:34:40
