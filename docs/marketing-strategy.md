...
Four audiences, not two. Different message, different channel, different moment.
...
### D — Workplace, club, five-a-side team
**Under-weighted so far and probably the easiest first revenue.** No landlord gatekeeper, no
premises, no licensing question, and the buyer is the same person as the user. Office of 40
crosses the free tier immediately.
**Message:** same as C without the pub framing.
**Channel:** search, content, word of mouth. No artwork exists yet.

---

## 5. What we do not say

Beyond the honesty rules in the design system:

- **Never "make money for your club".** The landlord leaflet correctly sells footfall and dwell
  time, and that is both the truer benefit and the safer one. The moment we say "make money" we
  are marketing the venue's stake-and-pot scheme, which is a licensing conversation we have no
  business being in. Our revenue is player places; the venue's benefit is people in the building.
...
- Does audience D get its own artwork, or does the landlord leaflet reword cheaply enough?
