...
### 2️⃣ COLLECT MONEY
✅ Players join online using the link/code above
✅ You collect entry fees your way (cash, bank transfer, whatever works)
✅ You keep and manage all the money

**Important:** All entry fees and prizes are handled by you, completely independent of LMSLocal.
...
You're welcome to:
- Post updates in the WhatsApp group yourself
- Remind players about picks
- Answer questions about the competition
- Build excitement and banter!

**But you don't have to** - we'll handle it all if you prefer.

---

## MONEY MANAGEMENT

⚠️ **You are 100% responsible for:**
- Collecting entry fees from players
- Managing the prize pot
- Distributing prizes at the end
...
**We never touch the money - it's completely separate.**
