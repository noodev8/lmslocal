...
import { competitionApi, UpdateCompetitionRequest, ResetCompetitionRequest } from '@/lib/api';
            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  <Cog6ToothIcon className="h-6 w-6 text-slate-700" />
                  <h1 className="text-lg font-semibold text-slate-900">Competition Settings</h1>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-lg font-semibold text-slate-900">Competition Settings</h1>
                  {competition && <p className="text-sm text-slate-500 truncate">{competition.name}</p>}
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between">
              <div className="flex-1 mb-4 sm:mb-0 sm:mr-6">
                ...
                <p className="text-slate-600 mb-2">
                  Completely reset this competition to its initial state. This will:
                </p>
                <ul className="text-sm text-slate-600 list-disc list-inside space-y-1 mb-4">
                  <li>Delete all rounds, fixtures, and results</li>
                  <li>Reset all players to active with full lives</li>
                  <li>Existing players can later be removed</li>
                  <li>New players can join</li>
                </ul>
