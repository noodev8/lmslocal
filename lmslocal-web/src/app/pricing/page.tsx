      ...
      <section className="bg-slate-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto">
            Simple player-based pricing that grows with your competition. No hidden fees, cancel anytime.
          </p>

          {/* Beta Notice */}
          <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 mb-12 max-w-2xl mx-auto">
            <div className="flex items-center justify-center">
              <span className="bg-emerald-500 text-white px-3 py-1 rounded-full text-xs font-bold mr-3">BETA</span>
              <p className="text-emerald-800 font-medium">
                Currently in free beta mode - all features available at no cost during testing period
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-16">
            <div className="bg-white rounded-lg p-6 border border-slate-200">
              <div className="text-2xl font-bold text-slate-900 mb-2">🎯 FREE TIER</div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600">All plans include unlimited competitions</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-lg p-8 border border-slate-200 relative">
              <div className="text-center">
                ...
                <p className="text-slate-600 mb-6">Perfect for small groups</p>
                ...
                <ul className="space-y-3 mb-8 text-left">
                  ...
                  <li className="flex items-center">
                    <span className="text-green-600 mr-2">✓</span>
                    <span className="text-sm">1 active competition</span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-600 mr-2">✓</span>
                    <span className="text-sm">Manual fixture/results</span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-600 mr-2">✓</span>
            ...
            <div className="bg-slate-900 text-white rounded-lg p-8 border border-slate-700 relative transform scale-105 shadow-xl">
              ...
              <div className="text-center">
                ...
                <p className="text-slate-300 mb-6">For pubs & workplaces</p>

                <ul className="space-y-3 mb-8 text-left">
                  <li className="flex items-center">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span className="text-sm">Up to 50 players</span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-emerald-400 mr-2">✓</span>
                  ...
                  <li className="flex items-center">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span className="text-sm">Custom branding (logo, colors)</span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span className="text-sm">Marketing toolkit (QR codes, social)</span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-emerald-400 mr-2">✓</span>
            ...
            <div className="bg-white rounded-lg p-8 border border-slate-200 relative">
              <div className="text-center">
                ...
                <p className="text-slate-600 mb-6">Premium automation & support</p>

                <ul className="space-y-3 mb-8 text-left">
                  <li className="flex items-center">
                    <span className="text-green-600 mr-2">✓</span>
                    <span className="text-sm">Up to 500 players</span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-600 mr-2">✓</span>
                  ...
                  <li className="flex items-center">
                    <span className="text-green-600 mr-2">✓</span>
                    <span className="text-sm">Auto fixture generation</span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-600 mr-2">✓</span>
                    <span className="text-sm">Auto results updates</span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-600 mr-2">✓</span>
          ...
          <div className="text-center mt-12">
            <div className="bg-slate-50 rounded-lg p-6 border border-slate-200 inline-block">
              <p className="text-slate-700 mb-4">
                <strong>Need more than 500 players?</strong>
              </p>
              <Link
                href="/contact"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 border border-slate-200">
              ...
              <p className="text-slate-600">Yes! You can cancel your paid subscription at any time. Your competitions continue until the end of your billing period, then revert to Free plan limits.</p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 border border-slate-200">
              <h3 className="text-lg font-semibold text-slate-900 mb-3">How does the marketing toolkit work?</h3>
              <p className="text-slate-600">Generate QR codes for easy joining, custom landing pages with your branding, social media sharing templates, and email invitation tools.</p>
            </div>
      ...
      <section className="py-20 bg-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Join competition organizers who trust LMSLocal to run their Last Man Standing games
          </p>
