...
Success Response (ALWAYS HTTP 200):
{
  ...
  "blocked_joins": {                            // object|null. Null when nothing was blocked, and
                                                // also once the organiser has room again - a
                                                // resolved block is never reported.
  ...
  try {
    ...
    const mainQuery = `
      SELECT DISTINCT
        ...
        c.ready_at,                            -- Organiser pressed Ready; null = fixture service waiting on them
