...
=======================================================================================================================================
Method: POST
Purpose: Allows competition organizers to add fixtures for a new round. Only works for manual
         competitions (fixture_service = false) - automated competitions are read-only on the
         organiser side, the fixture service owns their fixtures. Fixtures must be added in one
         transaction per round. Requires previous round to be fully processed before adding new
         round.
=======================================================================================================================================
Request Payload:
{
