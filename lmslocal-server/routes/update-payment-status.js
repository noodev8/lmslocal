...
Request Payload:
{
  ...
  // Note: paid_amount removed - column doesn't exist in schema
...
Success Response (ALWAYS HTTP 200):
{
  ...
  "payment_status": {
    ...
    "previous_status": {               // object, payment status before update (for audit)
      ...
      // paid_amount removed - column doesn't exist
...
router.post('/', verifyToken, async (req, res) => {
  try {
    ...
    if (paid_date !== undefined && paid_date !== null && typeof paid_date !== 'string') {
      return res.json({
        return_code: "VALIDATION_ERROR",
